...
var bt1 = (<HTMLButtonElement>document.getElementById('hit1'));
        ...
        var game = new Cricket(inp);                                                                      (<HTMLButtonElement>document.getElementById('hit1')).setAttribute('onclick','game.bowling("player","score1")');                                                          
                                     (<HTMLButtonElement>document.getElementById('hit2')).setAttribute('onclick','game.bowling("p","score2")');
