                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        res.forEach(function (ticket) {
                            card.innerHTML += "<div class=\"card\">\n          <div class=\"card-header\" >\n    " + ticket.type + "\n  </div>\n  <div class=\"card-body\">\n    <h5 class=\"card-title\">" + ticket.subject + "</h5>\n<p class = \"card-text\" > id : " + ticket.id + " &nbsp;&nbsp;\nCreated : " + ticket.created_at.split('T') + " &nbsp;\n&nbsp;\nDue : " + ticket.due_by.split('T') + "\n</p>\n\n<button type =\"button\" class =\"btn btn-warning tedit\" data-toggle=\"modal\" data-target=\"#exampleModalCenter\" i = \"" + ticket.id + "\" typ=\"" + ticket.type + "\" sub=\"" + ticket.subject + "\"> Edit </button> <a i=\"" + ticket.id + "\"  href=\"#\" class=\"btn btn-danger tdel\" id=\"delete\" >Delete</a>\n\n\n\n\n</div>";
                        });
                        tedit = document.querySelectorAll('.tedit');
                        tedit.forEach(function (btn) {
                        ...
                        list = document.querySelectorAll('.tdel');
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        res.forEach(function (contact) {
                            document.getElementById('tbody').innerHTML += "\n    <tr>\n     \n      <td>" + contact.name + "</td>\n      <td>" + contact.job_title + "</td>\n      <td>" + contact.company_id + "</td>\n<td> " + contact.email + " </td>\n      <td>@" + contact.phone + "</td>\n<td> <button type = \"button\" class = \"btn btn-warning edit fa fa-plus\"  data-toggle =\"modal\" data-target =\"#ContactUpdate\" i = \"" + contact.id + "\" name=\"" + contact.name + "\" email=\"" + contact.email + "\"> </button>\n\n</td>\n<td> <button type = \"button\" class = \"btn btn-danger del fa fa-trash\"   i = \"" + contact.id + "\"></button>\n</td>\n    </tr>";
                        });
                        ...
                        list = document.querySelectorAll('.del');
                        list.forEach(function (btn) {
                            var id = +btn.getAttribute('i');
                            btn.addEventListener('click', function () {
                                console.log(this.id);
